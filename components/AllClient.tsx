...
import TableSkeletons from "@/components/skeleton/TableSkeleton"
...
export default function ManageClient() {
  ...
  return (
    <div className="w-full">
      <div className="flex items-center justify-between px-2 mt-5 bg-orange-200 rounded-md ">
                ...
                <>
                  ...
                  >
                    {row.getVisibleCells().map((cell) => (
                      ...
                      <div className="w-[22px] h-[22px] flex items-center justify-center rounded-full border-2 border-orange-500"> <User className="text-orange-500 rounded-full " /></div>:""}
                        {flexRender(
