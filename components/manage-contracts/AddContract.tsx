  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button className="flex items-center justify-center px-2 py-1 text-white rounded-md hover:bg-black bg-orange-500">
          <span className="inline-block mr-1 min-w-18">Contract </span>
