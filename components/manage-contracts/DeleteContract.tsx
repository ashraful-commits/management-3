            ...
            <Tooltip>
              <TooltipTrigger asChild>
                  <AlertDialog>
                    ...
                    <button varient="outline" className="p-1 text-black transition-all duration-200 ease-in-out bg-white bg-red-500 rounded-md hover:text-white hover:bg-red-500">
                <X  size={15}/>
                </button>
                    </AlertDialogTrigger>
